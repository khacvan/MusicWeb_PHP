  ...
  <aside class="app-sidebar">
    ...
    <hr>
      <ul class="app-menu">
          ...
          <li><a class="app-menu__item" href="singer_data.php"><i class='app-menu__icon bx bx-user-voice'></i><span
                          class="app-menu__label">Quản lý ca sĩ</span></a></li>
          <li><a class="app-menu__item" href="table-data-product.html"><i
                          class='app-menu__icon bx bx-purchase-tag-alt'></i><span class="app-menu__label">Top bài hát</span></a>
          </li>
      </ul>
          ...
          <div class="tile-body">
            ...
            <div class="row element-button">
              <div class="col-sm-2">
                ...
                <a class="btn btn-add btn-sm" href="add_song.html" title="Thêm"><i class="fas fa-plus"></i>
                  Thêm tài khoản</a>
              </div>
              <div class="col-sm-2">
                    ...
                    foreach ($listUsers as $user) {
                        ?>
                            <tr>
                                ...
                                <td><?= $user['id'] ?></td>
                                <td width="100"><img src="<?= $user['avatar'] ?>" alt=""></td>
                                <td><?= $user['username'] ?></td>
                                <td><?= $user['email'] ?></td>
